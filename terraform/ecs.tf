...
resource "aws_ecs_service" "app" {
  ...
  # Zero-downtime rolling deploys: always keep 100% capacity healthy,
  # allow bursting to 200% while the new tasks come up.
  ...
  lifecycle {
    ignore_changes = [task_definition] # allow CI to update this independently via deploy step
  }
}
